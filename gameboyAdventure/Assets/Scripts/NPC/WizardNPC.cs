...
public class WizardNPC : MonoBehaviour, IInteractable
{
    ...
    public void Interact()
    {
        ...
        {
            if (QuestTracker.Instance.hasWand == true) { QuestTracker.Instance.GiveWand(); }
            StartDialogue();
        }
    }
    ...
    void StartDialogue()
    {
        if (QuestTracker.Instance.hasWand == true && currentDialogueDataIndex < (dialogueData.Length - 1)) { currentDialogueDataIndex++; }
